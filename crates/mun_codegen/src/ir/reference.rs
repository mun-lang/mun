...
///
/// The handle is stored as `**T`: the runtime may replace `*T` while generated
/// references remain valid. Keeping `T` explicitly avoids recovering semantic
/// information from LLVM pointer types.
