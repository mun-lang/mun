...
/// Generates a `FunctionValue` for a `hir::Function` that is usable from the public API. This
/// function does not generate a body for the `hir::Function`. That task is left to the `gen_body`
