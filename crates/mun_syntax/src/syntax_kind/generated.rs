...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            BREAK_KW | DO_KW | ELSE_KW | FALSE_KW | FOR_KW | FN_KW | IF_KW | IN_KW | NIL_KW
            | RETURN_KW | TRUE_KW | WHILE_KW | LOOP_KW | LET_KW | MUT_KW | CLASS_KW | STRUCT_KW
            | NEVER_KW | PUB_KW | PACKAGE_KW | SUPER_KW | SELF_KW | EXTERN_KW => true,
            _ => false,
        }
    }
    ...
    pub fn is_symbol(self) -> bool {
        match self {
            AMP | PIPE | PLUS | MINUS | STAR | SLASH | PERCENT | CARET | HASH | DOT | LT | GT
            | EQ | L_PAREN | R_PAREN | L_CURLY | R_CURLY | L_BRACKET | R_BRACKET | SEMI | COLON
            | COMMA | EXCLAMATION | UNDERSCORE | EQEQ | NEQ | LTEQ | GTEQ | DOTDOT | DOTDOTDOT
            | PLUSEQ | MINUSEQ | STAREQ | SLASHEQ | PERCENTEQ | SHLEQ | SHREQ | AMPEQ | PIPEEQ
            | CARETEQ | DOTDOTEQ | COLONCOLON | THIN_ARROW | AMPAMP | PIPEPIPE | SHL | SHR => true,
            _ => false,
        }
    }
    ...
    pub(crate) fn info(self) -> &'static SyntaxInfo {
        match self {
            ...
            SOURCE_FILE => &SyntaxInfo {
                name: "SOURCE_FILE",
            },
            FUNCTION_DEF => &SyntaxInfo {
                name: "FUNCTION_DEF",
            },
            ...
            MEMORY_TYPE_SPECIFIER => &SyntaxInfo {
                name: "MEMORY_TYPE_SPECIFIER",
            },
            RECORD_FIELD_DEF_LIST => &SyntaxInfo {
                name: "RECORD_FIELD_DEF_LIST",
            },
            RECORD_FIELD_DEF => &SyntaxInfo {
                name: "RECORD_FIELD_DEF",
            },
            TUPLE_FIELD_DEF_LIST => &SyntaxInfo {
                name: "TUPLE_FIELD_DEF_LIST",
            },
            TUPLE_FIELD_DEF => &SyntaxInfo {
                name: "TUPLE_FIELD_DEF",
            },
            ...
            PATH_SEGMENT => &SyntaxInfo {
                name: "PATH_SEGMENT",
            },
            RECORD_LIT => &SyntaxInfo { name: "RECORD_LIT" },
            RECORD_FIELD_LIST => &SyntaxInfo {
                name: "RECORD_FIELD_LIST",
            },
            RECORD_FIELD => &SyntaxInfo {
                name: "RECORD_FIELD",
            },
