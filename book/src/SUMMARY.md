...
- [Arrays](ch03-00-arrays.md)

  - [Dynamically Sized Arrays](ch03-01-dynamically-sized-arrays.md)
  - [Marshalling Arrays](ch03-02-marshalling-arrays.md)

- [Structs](ch04-00-structs.md)

  - [Records vs Tuples](ch04-01-records-vs-tuples.md)
  - [Struct Memory Kind](ch04-02-struct-memory-kind.md)
  - [Marshalling Structs](ch04-03-marshalling-structs.md)
  - [Hot Reloading](ch04-04-hot-reloading.md)

- [Developer Documentation](dev/00-developer-docs.md)

  - [Salsa](dev/01-salsa.md)
  - [Building LLVM](dev/02-building-llvm.md)
